...
static void handleFtlContractAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  ...
  D->addAttr(::new (S.Context)
                 FtlContractAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleFtlActionAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 FtlActionAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleFtlTableAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 FtlTableAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}
...
static void ProcessDeclAttribute(Sema &S, Scope *scope, Decl *D,
  ...
  default:
    ...
    break;
  case AttributeList::AT_FtlWasmImport:
    handleSimpleAttribute<FtlWasmImportAttr>(S, D, AL);
    break;
  case AttributeList::AT_FtlWasmEntry:
    handleSimpleAttribute<FtlWasmEntryAttr>(S, D, AL);
    break;
  case AttributeList::AT_FtlIgnore:
    handleSimpleAttribute<FtlIgnoreAttr>(S, D, AL);
    break;
  case AttributeList::AT_FtlAction:
    handleFtlActionAttribute(S, D, AL);
    break;
  case AttributeList::AT_FtlTable:
    handleFtlTableAttribute(S, D, AL);
    break;
  case AttributeList::AT_FtlContract:
    handleFtlContractAttribute(S, D, AL);
    break;
