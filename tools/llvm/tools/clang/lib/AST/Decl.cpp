...
bool RecordDecl::isFtlIgnore() const { return hasAttr<FtlIgnoreAttr>(); }
...
bool FunctionDecl::isFtlWasmEntry()const { return hasAttr<FtlWasmEntryAttr>(); }
bool FunctionDecl::isFtlWasmImport()const { return hasAttr<FtlWasmImportAttr>(); }
