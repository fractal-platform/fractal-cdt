...
public:
  ...
  bool isFtlContract() const { return hasAttr<FtlContractAttr>(); }
  bool isFtlAction() const { return hasAttr<FtlActionAttr>(); }
  bool isFtlTable() const { return hasAttr<FtlTableAttr>(); }
  bool isFtlIgnore() const { return hasAttr<FtlIgnoreAttr>(); }
  FtlActionAttr* getFtlActionAttr() const { return getAttr<FtlActionAttr>(); }
  FtlTableAttr*  getFtlTableAttr() const { return getAttr<FtlTableAttr>(); }
  FtlContractAttr*  getFtlContractAttr() const { return getAttr<FtlContractAttr>(); }
