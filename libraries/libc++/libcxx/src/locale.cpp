...
extern "C" void ftl_assert(bool, const char*);
size_t strftime(char*, size_t, const char*, const struct tm*) { ftl_assert(false, "strftime called"); }
size_t strftime_l(char*, size_t, const char*, const struct tm*, locale_t) { ftl_assert(false, "strftime_l called"); }
